...
class C(BaseConstants):
    NAME_IN_URL = 'trust_tech_task'
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 4
    INSTRUCTIONS_TEMPLATE = 'trust_tech_task/instructions.html'
...
class Group(BaseGroup):
    ...
    sent_back_amount = models.IntegerField(doc="""Amount sent back by P2""", min=cu(0))
...
class Results(Page):
    ...
    def vars_for_template(player: Player):
        group = player.group
        return dict(tripled_amount=group.sent_amount * C.MULTIPLIER, others=player.get_others_in_group())
